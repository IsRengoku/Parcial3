    ...
    public class clsLogin
    {
        ...
        private bool ValidarUsuario()
        {
            try
            {
                ...
                Usuario usuario = dbExamen.Usuarios.FirstOrDefault(u => u.userName == login.Usuario);
                if (usuario == null)
                {
        ...
        private bool ValidarClave()
        {
            try
            {
                ...
                Usuario usuario = dbExamen.Usuarios.FirstOrDefault(u => u.userName == login.Usuario && u.Clave == login.Clave);
                if (usuario == null)
                {
        ...
        public IQueryable<LoginRespuesta> Ingresar()
        {
            ...
            if (ValidarUsuario() && ValidarClave())
            {
                ...
                return from U in dbExamen.Set<Usuario>()
                       join UP in dbExamen.Set<Usuario_Perfil>()
                       on U.idUsuario equals UP.idUsuario
                       join P in dbExamen.Set<Perfil>()
